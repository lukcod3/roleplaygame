    ...
    void updateInventory(MouseEvent e) {
        ...
        if (e.getButton() == 3 && statsShown) {
            if (isCourserInRectangle(590, 650, 100, 160) && equipment[0].itemNr != 0) {
                ...
                aktInventar = 3;
            } else if (isCourserInRectangle(590, 650, 330, 390) && equipment[3].itemNr != 0) {
                aktInventar = 4;
            } else if (isCourserInRectangle(680, 740, 155, 215) && equipment[4].itemNr != 0) {
                aktInventar = 5;
            } else if (isCourserInRectangle(680, 740, 230, 290) && equipment[5].itemNr != 0) {
                aktInventar = 6;
            } else if (isCourserInRectangle(680, 740, 305, 365) && equipment[6].itemNr != 0) {
                aktInventar = 7;
