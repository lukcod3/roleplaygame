...
Jonas implementierte den Shop fertig und er implementierte ein Portal welches den Spieler nach dem Level zurück zum Hub bringt. Außerdem implementierte er das Grundgerüst dafür, dass Musik abgespielt werden kann. Es muss nurnoch ein passender Song eingefügt werden. Er lößte das Problem, dass der Magier kein Projektil geschossen hat, wenn eine Bewegungstaste losgelassen wurde und sofort danach angegriffen wurde.\\
